...
// Include Eigen headers and common types
#include <Eigen/Core>
#include <Eigen/Dense>
...
// Vec2i can be used for indexing, defining its less-than operator for constructing maps with it as key
namespace imu_gps {
...
// Implement comparisons for 2D and 3D
template <>
...
inline SE3 Mat4ToSE3(const Eigen::Matrix<S, 4, 4>& m) {
    /// Normalize R to prevent failure in checks inside Sophus
